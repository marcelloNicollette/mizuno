                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-lg text-gray-900">{{ $segmentacaoCliente->created_at->format('d/m/Y H:i') }}</p>
                        </div>
                        ...
                        @if($segmentacaoCliente->produtos_segmentos)
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-500">Produtos Segmentos</label>
                                <p class="mt-1 text-lg text-gray-900 whitespace-pre-line">{{ $segmentacaoCliente->produtos_segmentos }}</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        {{ $segmentacaoCliente->users->count() }} {{ $segmentacaoCliente->users->count() === 1 ? 'usuário' : 'usuários' }}
                    </span>
                </div>
