...
@section('page_title', 'Itens de Tecnologia')
...
@section('content-wrapper')
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.technology.items.create') }}"
                            ...
                            @foreach ($items as $item)
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @else
                                            <span class="text-gray-400">Sem ícone</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-3">
                                            <a href="{{ route('admin.technology.items.edit', $item) }}"
                                            ...
                                            <form action="{{ route('admin.technology.items.destroy', $item) }}"
