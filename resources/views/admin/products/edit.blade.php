                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-4">
                                            ...
                                            <div class="col-span-full border border-gray-200 rounded-md bg-white p-4">
                                                <div class="flex items-center justify-between gap-4 mb-3">
                                                    <label class="block text-sm font-medium text-gray-700">Size Run ME</label>
                                                    <select :name="`color_size_run_enabled[]`" x-model="campo.color_size_run_enabled"
                                                ...
                                                @if (isset($sizeRuns) && $sizeRuns->count() > 0)
                                                    <div x-show="campo.color_size_run_enabled == '1'" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Tabela Size Run</label>
                                                            <select :name="`color_size_run_id[]`" x-model="campo.color_size_run_id"
                                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                        ...
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Article Label</label>
                                                        ...
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Article Value</label>
                                                        ...
                                                        <div>
                                                            <label class="block text-xs font-medium text-gray-700">Tabela ME Article Gen</label>
                                                ...
                                                @else
                                                    <div class="p-3 border border-indigo-200 rounded-md bg-gray-50 text-center">
                                                        <p class="text-xs text-gray-500 mb-1">Nenhum Size Run disponivel.</p>
