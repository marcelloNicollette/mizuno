            ...
            <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    @if ($banner->image)
                        <div class="mt-2 relative group">
                            <img src="{{ asset('/' . $banner->image) }}" alt="Imagem atual"
                ...
                <div class="mb-6">
                    ...
                    @if ($banner->image_mobile)
                        <div class="mt-2 relative group">
                            <img src="{{ asset('/' . $banner->image_mobile) }}" alt="Imagem atual"
                                class="h-32 w-auto object-cover rounded-lg shadow-sm">
                            <div
                                class="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition duration-150 ease-in-out rounded-lg flex items-center justify-center">
                                <span class="text-white text-sm">Imagem atual</span>
                ...
                <div class="mb-4">
                    ...
                    <div class="space-y-2">
                        @php
                            ...
                            $currentLevels = old('access_levels', $banner->access_levels ?? []);
                        @endphp
                ...
                <div class="mb-4">
                    ...
                    <select name="active" id="active"
                        ...
                        <option value="1" {{ old('active', $banner->active) == '1' ? 'selected' : '' }}>Ativo
                        </option>
                        <option value="0" {{ old('active', $banner->active) == '0' ? 'selected' : '' }}>Inativo
                        </option>
                    </select>
                    @error('active')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
